    ...
    <div className="mx-w-screen-2xl container mx-auto xl:px-24 px-4">
      ...
      <div className="bg-[#FAFAFA] py-10 px-4 lg:px-16">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          rows={6}
          defaultValue="lorem We cannot find an account with that mobile number By continuing, you agree to Amazon's Conditions of Use and Privacy Notice."
